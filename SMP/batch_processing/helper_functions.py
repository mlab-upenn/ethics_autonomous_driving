...
def save_solution_to_scenario(scenario: Scenario, planning_problem_set: PlanningProblemSet, trajectory: Trajectory, output_path: str) -> None:
    ...
    #save a copy of the current scenario with new dynamic obstacle
    
    scenario.add_objects(dynamic_obstacle)
    file_path = output_path + '/'+ str(scenario.scenario_id)
