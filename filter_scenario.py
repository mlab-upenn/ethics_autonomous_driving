...
def sort_scenario(scenario_id, scenario_loader, is_success):
    ...
    for tag in scenario.tags:
        ...
        elif tag == Tag.NO_ONCOMING_TRAFFIC:
        ...
        elif tag == Tag.EMERGENCY_BRAKING:
...
def print_stats():
    ...
    print(f"Turn left solutions found: {turn_left_success}/{turn_left}")
