...
from SMP.batch_processing.process_scenario import ResultType
import SMP.batch_processing.filter_scenario as fs
...
def run_parallel_processing():
    ...
    for idx, scenario_id in enumerate(result_dict[ResultType.SUCCESS]):
        fs.sort_scenario(scenario_id, scenario_loader, True)
    for idx, scenario_id in enumerate(result_dict["scenarios_to_process"]):
        fs.sort_scenario(scenario_id, scenario_loader, False)
