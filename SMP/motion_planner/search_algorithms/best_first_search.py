...
class BestFirstSearch(SearchBaseClass, ABC):
    ...
    def execute_search(self, dict_status_nodes) -> Tuple[Union[None, List[List[State]]], Union[None, List[MotionPrimitive]], Any]:
        ...
        while not self.frontier.empty():
            ...
            if self.reached_goal(node_current.list_paths[-1]):
                ...
                # return solution
                return path_solution, node_current.list_primitives, list_status_nodes, dict_status_nodes
        ...
        return None, None, None, dict_status_nodes
